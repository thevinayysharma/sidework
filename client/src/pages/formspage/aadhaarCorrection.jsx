...
export default function AadhaarCorrection() {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    ...
    formData.append("work", "Aadhaar Correction");
    console.log(values);
    setSubmitting(false);
  ...
  return (
    <div className="form-container">
      <div className="form_title">
        <h2>Aadhaar Correction</h2>
        <p className="direction">Home → Aadhaar Correction </p>
        <p>
